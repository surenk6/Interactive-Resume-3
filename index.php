...
<body>
  ...
  <div class="navigation">
    ...
    <section class="header">
        ...
        <div class="name-wrap">
            <div class="name-wrap-center">
                <p class="name"><span>Hi I'm</span><br> Suren <strong>Karapetyan</strong></p>
                <p class="title">a project manager. <br> and here are some of the projects I have worked on</p>
            </div>
        </div>
        </div>
    </section>
