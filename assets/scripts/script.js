...
$(document).ready(function(){
  ...
  /* testimony section arrow controls*/
    var TestimonialWrap = $(".testimonial-wrap");
    var TestimonyContent = $('.testimony-content');

    TestimonyContent.first().addClass("testimony-visible");
  $(".testimonial-star").first().addClass("testimonial-star-active");


  $(".testimonial-right").click(function(){
    var curActiveClient = TestimonialWrap.find(".testimony-visible");
    var position = TestimonialWrap.children().index(curActiveClient);
    var clientNum = TestimonyContent.length;
