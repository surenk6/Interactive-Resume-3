...
<body>
  ...
  <section class="header" id="header-work">
    ...
    <section class="recommendations" id="testimonials">
        <h1>testimonials</h1>
        <div class="testimonial-belt">
            ...
            <div class="testimonial-wrap">
                <div class="testimony-content">
                    <div class="testimoner">
                        <div class="testimoner-centering">
                            <div class="testimoner-photo">
                                <img src="assets/images/face.jpg" alt="">
                            </div>
                            <h2>Valod asfdghjhgjsdfh</h2>
                            <h3>alumni coordinator<br>sdafasdfalk ;lkatratjh ;lkj;lkdf</h3>
                        </div>
                    </div>
                    <div class="testimony-text">
                        <svg version="1.1" class="quote-left" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="475.082px" height="475.081px" viewBox="0 0 475.082 475.081" style="enable-background:new 0 0 475.082 475.081;"
                            xml:space="preserve">
                            <g>
                                <g>
                            ...
                            <svg version="1.1" class="quote-right" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="475.082px" height="475.081px" viewBox="0 0 475.082 475.081" style="enable-background:new 0 0 475.082 475.081;"
                                xml:space="preserve">
                                <g>
                                    <g>
                ...
                <div class="testinonials-dots">
                    <p class="testinonials-stars">
